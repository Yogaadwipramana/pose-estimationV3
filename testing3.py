...
def detectPose(image, pose, display=True):
    # (Kode deteksi pose yang telah Anda buat sebelumnya)
    '''
...
def calculateAngle(landmark1, landmark2, landmark3):
    # (Kode perhitungan sudut yang telah Anda buat sebelumnya)
    '''
...
def classifyPose(landmarks, output_image, display=False):
    # (Kode klasifikasi pose yang telah Anda buat sebelumnya)
    def classifyPose(landmarks, output_image, display=False):
        '''
